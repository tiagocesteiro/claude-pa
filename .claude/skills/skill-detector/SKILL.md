...
**Research skills:** Research sources → Data gathering → Analysis → Formatted output → Recommendations
**Monitoring skills:** What to check → Frequency → Thresholds → Alert format → Action items
**Content skills:** Input requirements → Structure → Tone/voice → Format → Quality checklist
**Integration skills:** API/tool → Authentication → Common operations → Error handling → Output format
