...
it("builds an assignment map from assigned guests only", () => {
  const a = assignmentFromGuests([
    { id: "g1", name: "A", groupId: null, assignedTableId: "t1", locked: false, extraGroups: null },
...
it("detects over-capacity and separated-together violations", () => {
  const guests = [
    { id: "g1", name: "A", groupId: null, assignedTableId: "t1", locked: false, extraGroups: null },
    { id: "g2", name: "B", groupId: null, assignedTableId: "t1", locked: false, extraGroups: null },
    { id: "g3", name: "C", groupId: null, assignedTableId: "t1", locked: false, extraGroups: null }, // 3 at cap-2 table
  ];
